...
```powershell
$tmp = "$env:TEMP\itadmin.ps1"; irm https://raw.githubusercontent.com/Mauri9291/Otimizer_M/main/IT_Admin_V5.2.ps1 -OutFile $tmp; powershell -ExecutionPolicy Bypass -File $tmp
```
